...
my $usage= "
assembles locus-annotated table from uniquer and usearch -cluster_fast results
...
open FA, $fafile or die "cannot open fasta file $cfile\n";
my %tag2seq={};
my $tag="";
my $seq="";
while (<FA>) {
...
open UNI, $ufile or die "cannot open uniqued file $ufile\n";
