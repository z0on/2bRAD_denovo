...
trim2bRAD_2barcodes_dedup_N.pl : 

Version of trim2bRAD_2barcodes_dedup.pl for data with Ns in the degenerate tag
...
my $degen="[NATGC][NATGC][AG][AT][NC][NC]";
my $adap="AGATC?";
